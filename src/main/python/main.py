...
def take_picture():
    def init_capture():
        ...
        os.popen("fswebcam -r 1920x1080 --no-banner -D 1 -S 100 --jpeg 100 --set contrast=50% --set brightness=3% --set focus_auto=1 --set backlight_compensation=10 /home/pi/Desktop/output.jpg")
    ...
    def start_pressed():
        try:
            if os.path.exists("/home/pi/Desktop/output.jpg"):
                os.remove("/home/pi/Desktop/output.jpg")
...
#         path = '/home/pi/Desktop/output.jpg'
#         call_obj_recog(path)
#
#     elif mode == 4:
